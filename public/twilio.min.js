  ...
  })()(
    {
      ...
      7: [
        function (require, module, exports) {
          ...
          var events_1 = require("events");
          var log_1 = require("./log");
          var AudioProcessorEventObserver = (function (_super) {
      ...
      8: [
        function (require, module, exports) {
          ...
          Object.defineProperty(exports, "__esModule", { value: true });
          var events_1 = require("events");
          var Backoff = (function (_super) {
            __extends(Backoff, _super);
            function Backoff(options) {
              var _this = _super.call(this) || this;
              Object.defineProperties(_this, {
                _attempts: { value: 0, writable: true },
                _duration: {
                  enumerable: false,
                  get: function () {
      ...
      9: [
        function (require, module, exports) {
          ...
          var BACKOFF_CONFIG = { factor: 1.1, jitter: 0.5, max: 3e4, min: 1 };
      ...
      14: [
        function (require, module, exports) {
          ...
          (function (SignatureValidationErrors) {
            var AccessTokenSignatureValidationFailed = (function (_super) {
          ...
          (function (GeneralErrors) {
            ...
            var ApplicationNotFoundError = (function (_super) {
            ...
            var ConnectionDeclinedError = (function (_super) {
          ...
          (function (MalformedRequestErrors) {
            ...
            var MissingParameterArrayError = (function (_super) {
            ...
            var AuthorizationTokenMissingError = (function (_super) {
            ...
            var MaxParameterLengthExceededError = (function (_super) {
            ...
            var InvalidBridgeTokenError = (function (_super) {
            ...
            var InvalidClientNameError = (function (_super) {
            ...
            var ReconnectParameterInvalidError = (function (_super) {
          ...
          (function (AuthorizationErrors) {
            ...
            var NoValidAccountError = (function (_super) {
            ...
            var InvalidJWTTokenError = (function (_super) {
            ...
            var JWTTokenExpiredError = (function (_super) {
            ...
            var RateExceededError = (function (_super) {
            ...
            var JWTTokenExpirationTooLongError = (function (_super) {
            ...
            var ReconnectAttemptError = (function (_super) {
            ...
            var CallMessageEventTypeInvalidError = (function (_super) {
            ...
            var PayloadSizeExceededError = (function (_super) {
      ...
      15: [
        function (require, module, exports) {
          ...
          var PRECISE_SIGNALING_ERROR_CODES = new Set([
            31001, 31002, 31003, 31101, 31102, 31103, 31104, 31105, 31107,
            31201, 31202, 31203, 31204, 31205, 31207, 31404, 31480, 31486,
            31603,
          ]);
        ...
        function (require, module, exports) {
          ...
          var PStream = (function (_super) {
            ...
            function PStream(token, uris, options) {
              ...
              var defaults = { TransportFactory: wstransport_1.default };
              options = options || {};
      ...
      33: [
        function (require, module, exports) {
          "use strict";
          Object.defineProperty(exports, "__esModule", { value: true });
          var MediaDeviceInfoShim = (function () {
              ...
              crypt = {
                ...
                endian: function (n) {
                  if (n.constructor == Number) {
                    return (
                      (crypt.rotl(n, 8) & 16711935) |
                      (crypt.rotl(n, 24) & 4278255360)
                    );
                  }
